...
To address the two drawbacks of traditional end-point detection algorithms, we develop a novel method based on short-term energy and zero-crossing rate that requires significantly fewer
