...
\cparagraph {The accuracy of sleep stage detection} \rt{In our experiment, we do not directly compare \systemname against medical-grade
      solutions for sleep stage detection.} If it was compared with polysomnography-based sleep stage detection, the accuracy of {\systemname} will
      ...
      quality. \rt{Nonetheless, in future work, we plan to compare \systemname against a polysomnography-based solution.}
