...
\subsection{\nt{Pilot Study: Training Data}}
\label{sec:trainingdata}

\nt{Prior to our main study, we carried out a pilot study that was used to inform our algorithm design and provide training data for the algorithms integrated into \systemname}. Our pilot study consisted of two two groups (aged ranged from 15 to 60). One group \nt{consisted of} randomly selected 100 volunteers to conduct questionnaire surveys to provide the basis for our algorithm design. The other group \nt{consisted of 10 users whose data was used to to train our models}.
