...
\hspace{3pt}
	...
	\caption{Average precision and recall for micro-body movement detection. The min-max bars show the range of achieved precision and recall across 15 participants.}\label{fig:micro_combine}
	\end{minipage}
\end{figure*}
...
& \multirow{4}*{{ \textbf{Recall}}} \\
   ...
   &   { Cough}   &   $3$      &   {\bf{{64}}}     &   $0$      &   $4$   &   {90.1\%} \\
    ...
    \hline
    & & & & & \\
    &   { \textbf{Precision}}      &   {96.9\%}   &   {88.9\%}   &   {91.3\%}   &   {95.6\%}    \\
    & & & & & \\
    \hline
   \end{tabular}
\end{table}
...
\renewcommand{\arraystretch}{0.59}{\centering}
 ...
 \vspace{-2mm}
	\begin{tabular}{c| r | r | r | r | r}
		...
		\cline{1-6}
		& & & & & \\
		&   { \textbf{Precision}}      &   {71.0\%}   &   {66.5\%}   &   {63.3\%}   \\
		& & & & & \\
		\hline
	\end{tabular}
\end{table}
...
\begin{tabularx}{\textwidth}{X cccccccccccccccc }
        \toprule
         ...
         \midrule
         \rowcolor{Gray}{\textbf{\systemname}} & 3 (1.8) & 3 (1.5) & 0 (1.0) & 1 (1.8) &  2 (1.2) &  2 (1.7) &  3 (1.0) & 0 (1.3) &  2 (1.3) &  2 (1.0) & 2 (0) & 2 (1.5) &  1 (1.8) &  0 (1.0) &  2 (1.3)\\
         ...
         {\textbf{\systemname}} & P&O&P&O&P&P&P&O&O&P&P&O&O&P&P\\
